        ...
        <!-- main -->
            <main class="main-content-wrapper">
                ...
                <div class="container">
                                ...
                                <div>
                                    ...
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb mb-0">
                                            ...
                                            <li class="breadcrumb-item"><a href="{{ url('articles') }}"
                                                                           class="text-inherit">Articles</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Modifier un
                                                article
                                            </li>
                                        </ol>
                                    </nav>
                    ...
                    <!-- row -->
                    <form action="{{ url('articles/'.$article->id.'/update') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="row">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-3 col-lg-6">
                                                ...
                                                <select class="form-select"
                                                    ...
                                                    @foreach($categorie as $value)
                                                        <option
                                                            value="{{ $value -> id }}"@if($value->id == $article->categorie_id) selected @endif>{{ $value -> nomCategorie }}</option>
                                                    @endforeach
                                            ...
                                            <div>
                                                <div class="mb-3 col-lg-12 mt-5">
                                                    ...
                                                    <div class="mb-4 d-flex">
                                                        ...
                                                        <img src="{{ asset('assets/uploads/articles_images/'.$article->image_path) }}" class="w-20 ml-5" alt="Image de la catégorie">
                                                        @endif
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="mb-3 col-lg-12 mt-5">
                                                ...
                                                <textarea class="form-control"
                                                          name="description" style="height: 130px"> {{$article->description}}</textarea>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div>
                                            <div class="mb-3">
                                                ...
                                                <input type="text" name="codeArticle" value="{{$article->codeArticle}}" class="form-control"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="status"
                                                           id="inlineRadio1" value="1" {{ $article->status === "1" ? 'checked' : '' }} />
                                                    <label class="form-check-label" for="inlineRadio1">Publié</label>
                                                </div>
                                                <!-- input -->
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="status"
                                                           id="inlineRadio2" value="0"{{ $article->status === "0" ? 'checked' : '' }} />
                                ...
                                <div class="card mb-6 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" name="prixAchatArticle" value="{{$article->prixAchatArticle}}"  class="form-control"
                                                   placeholder="0.00 FCFA"/>
                                        </div>
                                        <!-- input -->
                                        <div class="mb-3">
                                            <label class="form-label">Prix de vente</label>
                                            <input type="text" name="prixVenteArticle" value="{{$article->prixVenteArticle}}" class="form-control"
                                                   placeholder="0.00 FCFA"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <!-- button -->
                                <div class="d-grid">
                                    <button class="btn btn-primary" type="submit">Modifier un article</button>
                                </div>
                            </div>
                        </div>
                    </form>
