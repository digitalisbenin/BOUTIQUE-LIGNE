                                ...
                                <div class="card h-100 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-6">
                                            <div>
                                                <h4 class="mb-0 fs-5">Commandes</h4>
                                            </div>
                                        ...
                                        <div class="lh-1">
                                            @if($commande->count()> 0)
                                            <h1 class="mb-2 fw-bold fs-2">{{$commande->count()}}</h1>
                                            @else
                            ...
                            <div class="col-lg-3 col-12 mb-6">
                                ...
                                <div class="card h-100 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-6">
                                            <div>
                                                <h4 class="mb-0 fs-5">Catégories</h4>
                                            </div>
                            ...
                            <div class="col-lg-3 col-12 mb-6">
                                ...
                                <div class="card h-100 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-6">
                                            <div>
                                                <h4 class="mb-0 fs-5">Articles</h4>
                                            </div>
                            ...
                            <div class="col-lg-3 col-12 mb-6">
                                ...
                                <div class="card h-100 card-lg">
                                    ...
                                    <div class="card-body p-6">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mb-6">
                                            <div>
                                                <h4 class="mb-0 fs-5">Livreurs</h4>
                                            </div>
                                            <div class="icon-shape icon-md bg-light-info text-dark-info rounded-circle">
                                                <i class="bi bi-people fs-5"></i>
                                            </div>
                                        ...
                                        <div class="lh-1">
                                            @if($livreur->count()> 0)
                                            <h1 class="mb-2 fw-bold fs-2">{{$livreur->count()}}</h1>
                                            @else
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-12 mb-6">
                            <div class="card h-100 card-lg">
                                <!-- heading -->
                                <div class="p-6">
                                    <h3 class="mb-0 fs-5">Recent Commande</h3>
                                </div>
                                <div class="card-body p-0">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-centered table-borderless text-nowrap table-hover">
                                           ...
                                           <tr>
                                            <td>{{$value->numeroCommande}}</td>
                                            <td>{{$value->adresseLivraison}}</td>
                                            <td>{{$value->created_at}}</td>
                                            <td>{{$value->montantTotal}} FCFA</td>
                                            <td>
                                                {{--  <span class="badge bg-light-primary text-dark-primary">{{$value->status}}</span>  --}}
                                                <span class="badge
                                                @switch($value->status)
                                                    @case('En Attente')
