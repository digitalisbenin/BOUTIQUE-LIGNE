{{--  <footer class="footer">
    <div class="container">
            ...
            <div class="row align-items-center">
              <div class="col-lg-5 text-lg-start text-center mb-2 mb-lg-0">
                    <ul class="list-inline mb-0">
                        ...
                        <li class="list-inline-item">
                            <a href="#!"><img
                                    src="https://freshcart.codescandy.com/assets/images/payment//mastercard.svg" alt=""></a>
                        </li>
                        <li class="list-inline-item">
        ...
        <div class="border-top py-4">
            <div class="row align-items-center text-lg">
                <div class="col-md-6"><span class=" text-lg">© <span id="copyright">
      <script>document.getElementById('copyright').appendChild(document.createTextNode(new Date().getFullYear()))</script>
  </span>DIGIT-SHOPPING eCommerce.Tous droit réservées. Designer Par <a href="#"> Digitalis</a>.</span>
                </div>
                <div class="col-md-6">
                    <ul class="list-inline text-md-end mb-0 small mt-3 mt-md-0">
                        <li class="list-inline-item text-muted">Suivez-nous sur</li>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-8 col-md-12 col-lg-4">
                {{--  <a href="#"><h1 class="text-white">DIGIT-SHOPPING</h1>  --}}
                    <img class="cover"
                    src=
